...
export default {
  ...
  computed: {
    ...
    showClose() {
      let hasValue = this.multiple
        ...
        : this.currentValue !== undefined && this.currentValue !== null && this.currentValue !== '';
    ...
    visible(val) {
      if (!val) {
        ...
        if (this.isHiddenSetValue && this.multiple) {
          let val = Array.from(this.value).sort((m, n) => m - n);
          let oldVal = Array.from(this.currentValue).sort((m, n) => m - n);
  ...
  methods: {
    ...
    setSelected() {
      if (!this.multiple) {
        let option = this.getOption(this.currentValue);
        if (option.created) {
