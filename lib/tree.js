...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm.height
        ? _c("virtual-list", {
            style: { height: _vm.height + "px", "overflow-y": "auto" },
            attrs: {
              "data-key": _vm.getNodeKey,
              "data-sources": _vm.visibleList,
              "data-component": _vm.itemComponent,
              keeps: Math.ceil(_vm.height / 22) + _vm.extraLine,
              "extra-props": {
...
var external_vue_virtual_scroll_list_ = __webpack_require__(49);
...
// CONCATENATED MODULE: ./packages/tree/src/mixin/node.js


/* harmony default export */ var mixin_node = ({
  methods: {
    creator: function creator(parent, nodeTag) {
      ...
      this.$watch(nodeTag + '.data.' + childrenKey, function () {
        node.updateChildren();
      });
...
/* harmony default export */ var tree_nodevue_type_script_lang_js_ = ({
  ...
  mixins: [emitter_default.a, mixin_node],
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./packages/tree/src/tree-virtual-node.vue?vue&type=template&id=7a0bd9fb&
var tree_virtual_nodevue_type_template_id_7a0bd9fb_render = function() {
  var this$1 = this
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _c(
        ...
        [
          _c("span", {
            style: { width: (_vm.source.level - 1) * _vm.tree.indent + "px" },
          ...
          _vm.source.loading
            ...
            : _vm._e(),
          _c("node-content", { attrs: { node: _vm.source } })
        ],
        1
      )
    ]
...
var tree_virtual_nodevue_type_template_id_7a0bd9fb_staticRenderFns = []
tree_virtual_nodevue_type_template_id_7a0bd9fb_render._withStripped = true


// CONCATENATED MODULE: ./packages/tree/src/tree-virtual-node.vue?vue&type=template&id=7a0bd9fb&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib!./node_modules/vue-loader/lib??vue-loader-options!./packages/tree/src/tree-virtual-node.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var tree_virtual_nodevue_type_script_lang_js_ = ({
...
// CONCATENATED MODULE: ./packages/tree/src/tree-virtual-node.vue?vue&type=script&lang=js&
 /* harmony default export */ var src_tree_virtual_nodevue_type_script_lang_js_ = (tree_virtual_nodevue_type_script_lang_js_); 
// CONCATENATED MODULE: ./packages/tree/src/tree-virtual-node.vue
...
var tree_virtual_node_component = Object(componentNormalizer["a" /* default */])(
  src_tree_virtual_nodevue_type_script_lang_js_,
  tree_virtual_nodevue_type_template_id_7a0bd9fb_render,
  tree_virtual_nodevue_type_template_id_7a0bd9fb_staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var tree_virtual_node_api; }
tree_virtual_node_component.options.__file = "packages/tree/src/tree-virtual-node.vue"
/* harmony default export */ var tree_virtual_node = (tree_virtual_node_component.exports);
...
/* harmony default export */ var treevue_type_script_lang_js_ = ({
  ...
  components: {
    VirtualList: external_vue_virtual_scroll_list_default.a,
  ...
  data: function data() {
    return {
      ...
      itemComponent: tree_virtual_node
    };
  },
    ...
    flattenTree: function flattenTree(datas) {
      ...
      return datas.reduce(function (conn, data) {
        ...
        if (data.expanded && data.childNodes.length) {
          conn.push.apply(conn, _this.flattenTree(data.childNodes));
        }
        return conn;
      }, []);
    },
